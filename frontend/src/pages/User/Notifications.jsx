												...
												>
													...
													<div className='flex flex-col p-2 my-4'>
														<div className='flex mb-3'>
															<div className='font-semibold mr-1'>Title:</div>
															<div className='w-full text-center'>
																{notification.support_title}
															</div>
														</div>
														<div className='mb-3'>
															<div className='font-semibold mr-1'>Request:</div>
															<div className=''>
														...
														<div className='flex'>
															<div className='font-semibold mr-1'>Admin:</div>
															<div className=''>
														...
														<div className='flex'>
															<div className='font-semibold mr-1'>Date:</div>
															<div className=''>
																{formatDate(notification.created_at)}
															</div>
														</div>
