	...
	return (
		<div className={styles.Container}>
			<div className={styles.Block}>
                ...
                <section>
                    <div className={styles.TermsHeader}>Політика конфіденційності CyberBet</div>
                ...
                <section>
                    ...
                    <div className={styles.TermsHeader}>Збір даних та їх використання</div>

                    <p>Оператор збирає різноманітні дані про гравців для забезпечення якісних послуг та дотримання законодавчих вимог. Ця інформація включає особисті дані (ім’я, адреса, дата народження), контактні дані (номер телефону, адреса електронної пошти) і фінансову інформацію для обробки транзакцій. Дані використовуються для створення та управління обліковим записом, надання підтримки, виконання обов’язкових перевірок, інформування про події та акції, а також для інших вказаних нижче цілей.</p>
                    <p>1. Інформація про гравця збирається для таких цілей:</p>
                    <ul>
                        <li>створення облікового запису гравця та надання йому повного доступу до всіх функцій, включаючи ставки та ігри;</li>
                        <li>обробка запитань та коментарів через службу підтримки та своєчасна реакція на них;</li>
                        <li>дотримання правил реєстрації, наприклад, перевірка віку, та інформування про акції та події.</li>
                    </ul>
                    <p>2. Оператор також використовує інформацію про гравця, включаючи передачу даних партнерам і субпідрядникам, які обробляють їх від нашого імені, для наступних цілей:</p>
                    <ul>
                ...
                <section>
                    ...
                    <div className={styles.TermsHeader}>Оновлення інформації про гравця</div>
                ...
                <Link to={'/Registration'}>
                    <button className={styles.Back}>Back to registration</button>
                </Link>
