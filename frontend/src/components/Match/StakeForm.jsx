			...
			{Match ? (
				<div className='flex items-center bg-gray-700 rounded-lg  p-4 justify-around'>
					<div className='relative'>
						...
						/>
						<div className='absolute inset-0 bg-gradient-to-br from-transparent to-gray-700 to-80% opacity-70 rounded-lg'></div>

						<img
							src={Match.TeamLogo}
							alt='Smaller Image'
							className='absolute inset-0 mt-auto ml-auto mr-[5%] w-24 h-24'
						/>
					</div>
